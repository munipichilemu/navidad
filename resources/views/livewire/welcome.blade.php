...
<div class="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh] gap-8">
    <div class="lg:grid place-content-center py-8 lg:px-8">
        <div
            class="bg-gradient-to-br from-transparent to-gray-300/5 backdrop-blur-xl lg:rounded-lg lg:shadow-lg p-6 text-center">
            ...
            <p class="text-lg mb-8 max-w-[48ch]">
                Las inscripciones para la recepción de regalos navideños para la comuna de Pichilemu está disponible en
                el siguiente formulario.
            </p>

            <div class="mt-6">
                <a href="{{ route('inscribir') }}"
                   class="bg-emerald-600/40 text-white py-3 px-6 rounded-lg hover:bg-emerald-600/80 transition inline-flex items-center space-x-2">
